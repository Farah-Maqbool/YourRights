...
def train():
    ...
    try:
        Yourrights().crew().train(n_iterations=int(sys.argv[1]), filename=sys.argv[2], inputs=inputs)
...
def replay():
    ...
    """
    try:
        Yourrights().crew().replay(task_id=sys.argv[1])
...
def test():
    ...
    try:
        Yourrights().crew().test(n_iterations=int(sys.argv[1]), eval_llm=sys.argv[2], inputs=inputs)
